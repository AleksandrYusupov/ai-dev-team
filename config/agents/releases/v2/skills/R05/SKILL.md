...
- Description: Официальный пример скилла для фронтенд/дизайн-задач.
- Why: Можно адаптировать для FrontendBuildAgent и UX-support workflow.

## When To Use
- Официальный пример скилла для фронтенд/дизайн-задач.
