...
- Description: Официальный пример скилла для тестирования веб-приложений.
- Why: Нужен как база для E2E/TestAgent и smoke/monitoring-проверок UI.

## When To Use
- Официальный пример скилла для тестирования веб-приложений.
